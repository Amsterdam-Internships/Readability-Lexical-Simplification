...
PRETRAINED_MODEL_ARCHIVE_MAP = {
    ...
    # Dit is gefinetuned op Question- Answering:
    'bert-large-uncased-whole-word-masking-finetuned-squad': "https://s3.amazonaws.com/models.huggingface.co/bert/bert-large-uncased-whole-word-masking-finetuned-squad-pytorch_model.bin",
    'bert-large-cased-whole-word-masking-finetuned-squad': "https://s3.amazonaws.com/models.huggingface.co/bert/bert-large-cased-whole-word-masking-finetuned-squad-pytorch_model.bin",

    # Dit is gefinetuned op paraphrasing: Microsoft Research Paraphrase CorpusMicrosoft Research Paraphrase Corpus
    'bert-base-cased-finetuned-mrpc': "https://s3.amazonaws.com/models.huggingface.co/bert/bert-base-cased-finetuned-mrpc-pytorch_model.bin",

    'bert-pre-trained-readability': "readability/pytorch_model (1).bin"
}
...
PRETRAINED_CONFIG_ARCHIVE_MAP = {
    ...
    'bert-pre-trained-readability': "readability/config.json"

}
BERT_CONFIG_NAME = 'bert_config.json'
TF_WEIGHTS_NAME = 'wwm_uncased_L-24_H-1024_A-16/model.ckpt'
