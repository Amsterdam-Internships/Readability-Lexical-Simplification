...
def preprocess_subs_ranking(complex_word, generated_subs, embedding_dict, embedding_vector, word_count):
    ...
    for sub in generated_subs:
        ...
        # Dit als een eerste verbetering
        # if sub in word_count:
        #     sub_count = word_count[sub]
        # elif sub.lower() in word_count:
...
def substitution_selection(complex_word, predicted_tokens, ps, analysis, selection_size=10):
    """
    ...
    if analysis:
        with open("../selections.txt", "a") as analysis_file:
            analysis_file.write(str(subwords) + "\t" + str(actual_words) + "\t" + str(stem) + "\t" + str(too_close))
...
#     bert_sent = tokenizer.tokenize(sentence)
#     print(bert_sent)
#
...
#     token_index = 0
#
#     # This is the position where the new sentence starts: because of the MASK & SEP
#     start_pos = len(bert_sent) + 2
#
#     # Loop over the nltk tokenized words, make some corrections
#     for i, nltk_word in enumerate(nltk_sent):
#         bert_token = bert_sent[token_index]
#
#         if bert_token == "\"":
#             len_token = 2
#
#         elif nltk_word == "``":
#             print("are you ever heire")
#             nltk_word = "''"
#
#         else:
#             len_token = len(bert_token)
#
#         if bert_token == nltk_word or len_token >= len(nltk_word):
#             print("place 1", bert_token)
#             position2.append(start_pos + token_index)
#             token_index += 1
#
#         else:
#             print("place 2", bert_token)
#
#             new_pos = []
...
#
#             while new_word != nltk_word:  # Continue until the subwords have been recombined into the nltk
#                 print("in the loop")
#                 print(new_word)
#                 print(nltk_word)
#
